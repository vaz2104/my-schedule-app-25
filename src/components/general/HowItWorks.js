        ...
        >
            ...
            <div className="">
              <div className="text-center mx-2">
                <div className="flex justify-center">
                  <CirclePlusIcon className={"size-16 text-main"} />
                </div>
          ...
          <SwiperSlide>
            <div className="">
              <div className="text-center mx-2">
                <div className="flex justify-center">
                  <LinkPlusIcon className={"size-16 text-main"} />
                </div>
                <div className="font-bold text-lg mt-4 mb-2 text-gray-900">
                  Крок 2
                </div>
          ...
          <SwiperSlide>
            <div className="">
              <div className="text-center mx-2">
                <div className="flex justify-center">
                  <CalendarPlusIcon className={"size-16 text-main"} />
                </div>
                <div className="font-bold text-lg mt-4 mb-2 text-gray-900">
                  Крок 3
                </div>
          ...
          <SwiperSlide>
            <div className="">
              <div className="text-center mx-2">
                <div className="flex justify-center">
                  <ResultIcon className={"size-16 text-main"} />
                </div>
                <div className="font-bold text-lg mt-4 mb-2 text-gray-900">
                  Крок 4
                </div>
