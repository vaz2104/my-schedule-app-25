...
export const ExclamationFilledCircleIcon = ({ className }) => {
  return (
    <svg
      className={cn("w-3 h-3", className)}
      aria-hidden="true"
...
export const AngleIcon = ({ className }) => {
  return (
    <svg
      className={cn("w-3 h-3", className)}
      aria-hidden="true"
...
export const CalendarPlusIcon = ({ className }) => {
  return (
    <svg
      className={cn("w-3 h-3", className)}
      aria-hidden="true"
...
export const LinkPlusIcon = ({ className }) => {
  return (
    <svg
      className={cn("w-3 h-3", className)}
      aria-hidden="true"
...
export const ResultIcon = ({ className }) => {
  return (
    <svg
      className={cn("w-3 h-3", className)}
      aria-hidden="true"
...
export const PhoneSolidIcon = ({ className }) => {
  return (
    <svg
      className={cn("w-3 h-3", className)}
      aria-hidden="true"
